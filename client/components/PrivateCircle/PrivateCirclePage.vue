...
<template>
  <main>
    ...
    <p class="info">Allow you to post freets viewable only by followers in one of your Private Circles. Deleting a Private Circle will delete all freets posted to that Private Circle.</p>
